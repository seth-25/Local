...
class LEVELDB_EXPORT DB {
 public:
  ...
  static Status Open(const Options& options, const std::string& name, const void* db_jvm,
                     DB** dbptr);
  ...
  virtual void UnRef_am(int unref_version_id) = 0;
  virtual void UnRef_st(int unref_version_id) = 0;
